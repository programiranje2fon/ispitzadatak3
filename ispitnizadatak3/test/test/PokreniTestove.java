...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		runTestsForClass(MasinaZaCiscenjeSnegaTest.class);
		runTestsForClass(RatrakTest.class);
		runTestsForClass(GrtalicaTest.class);
		runTestsForClass(SluzbaZaPuteveTest.class);
	}
